...
if @sport.name == "Football"
	node(:football_passing) { |u| u.football_passing.to_s }
	node(:football_rushing) { |u| u.football_rushing.to_s }
	node(:football_receiving) { |u| u.football_receiving.to_s }
	node(:football_place_kicker) { |u| u.football_place_kicker.to_s }
	node(:football_kicker) { |u| u.football_kicker.to_s }
	node(:football_punter) { |u| u.football_punter.to_s }
	node(:football_returner) { |u| u.football_returner.to_s }
	node(:football_defense) { |u| u.football_defense.to_s }
