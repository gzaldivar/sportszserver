...
node(:waterpolo_game_id) { |s| s.id.to_s }
...
attributes :waterpolo_oppsog, waterpolo_oppsaves, :waterpolo_oppfouls, :waterpolo_oppassists, :home_exclusions, :visitor_exclusions, :home_time_outs_left,
		   :visitor_time_outs_left
